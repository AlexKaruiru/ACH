...
Public Class frmMDVTZ
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        Try
            ...
            'If chkTypeCCheque.Checked Then
            mdvBankID = New String("0", 3 - mdvBankID.Length) & mdvBankID
            'Else
            '    mdvBankID = New String("0", 2 - mdvBankID.Substring(mdvBankID.Length - 2).Length) & mdvBankID.Substring(mdvBankID.Length - 2)
            'End If
            ...
            'Else
            '    mdvBranchID = New String("0", 2 - mdvBranchID.Substring(mdvBranchID.Length - 2).Length) & mdvBranchID.Substring(mdvBranchID.Length - 2)
            'End If
            ...
            MDVMicr = mdvChequeID & mdvBankID & mdvBranchID & mdvAccount & mdvVoucherCode
            If chkTypeCCheque.Checked = True Then
                IsTypeCCheque = True
            Else
                IsTypeCCheque = False
            End If
    ...
    Private Sub txtBankID_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtBankID.LostFocus
        mdvBankID = txtBankID.Text.Replace("/", "")
        mdvBankID = mdvBankID.Trim(Space(3))
        mdvBankID = New String("0", 3 - mdvBankID.Length) & mdvBankID
        If mdvBankID = "000" Then
            mdvBankID = "001"
        End If
    ...
    Private Sub txtChequeDigit_LostFocus(sender As Object, e As EventArgs) Handles txtChequeDigit.LostFocus
        mdvChequeDigit = txtChequeDigit.Text.Replace("/", "")
        mdvChequeDigit = mdvChequeDigit.Trim(Space(2))
        mdvChequeDigit = New String("0", 2 - mdvChequeDigit.Length) & mdvChequeDigit

        txtChequeDigit.Text = mdvChequeDigit
    End Sub

    Private Sub txtChequeDigit_MaskInputRejected(sender As Object, e As MaskInputRejectedEventArgs) Handles txtChequeDigit.MaskInputRejected
