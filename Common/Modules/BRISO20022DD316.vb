...
Namespace BRISO20022DD316 ' Direct Debits 316
...
#End Region
    ...
    Partial Public Class Document
        ...
        Private fIToFICstmrDrctDbtField As FIToFICustomerDirectDebitV06
        ...
        Public Sub New()
            MyBase.New()
            Me.FIToFICstmrDrctDbt = New FIToFICustomerDirectDebitV06
        End Sub
        ''' <remarks/>
        Public Property FIToFICstmrDrctDbt() As FIToFICustomerDirectDebitV06
            Get
                Return Me.fIToFICstmrDrctDbtField
            End Get
            Set(value As FIToFICustomerDirectDebitV06)
    ...
    <System.ComponentModel.DesignerCategoryAttribute("code")> _
    <System.Xml.Serialization.XmlTypeAttribute([Namespace]:="urn:iso:std:iso:20022:tech:xsd:pacs.003.001.06")> _
    Partial Public Class FIToFICustomerDirectDebitV06
        Inherits EntityBase(Of FIToFICustomerDirectDebitV06)

        <EditorBrowsable(EditorBrowsableState.Never)> _
        Private grpHdrField As GroupHeader50

        <EditorBrowsable(EditorBrowsableState.Never)> _
        Private drctDbtTxInfField As List(Of DirectDebitTransactionInformation20)
        ...
        Public Sub New()
            MyBase.New()
            Me.drctDbtTxInfField = New List(Of DirectDebitTransactionInformation20)
            Me.grpHdrField = New GroupHeader50
        End Sub
        ''' <remarks/>
        Public Property GrpHdr() As GroupHeader50
            Get
                Return Me.grpHdrField
            End Get
            Set(value As GroupHeader50)
        ...
        Public Property DrctDbtTxInf() As List(Of DirectDebitTransactionInformation20)
            Get
                Return Me.drctDbtTxInfField
            End Get
            Set(value As List(Of DirectDebitTransactionInformation20))
    ...
    <System.ComponentModel.DesignerCategoryAttribute("code")> _
    <System.Xml.Serialization.XmlTypeAttribute([Namespace]:="urn:iso:std:iso:20022:tech:xsd:pacs.003.001.06")> _
    Partial Public Class GroupHeader50
        ...
        <EditorBrowsable(EditorBrowsableState.Never)> _
        Private In1 As System.DateTime
        ...
        <EditorBrowsable(EditorBrowsableState.Never)> _
        Private sttlmInfField As SettlementInstruction2
        ...
        Public Sub New()
            ...
            'Me.intrBkSttlmDtField = New System.DateTime
        ...
        ' ''' <remarks/>
        <System.Xml.Serialization.XmlElementAttribute("IntrBkSttlmDt", Order:=5)> _
        Public Property test() As System.DateTime
            Get
                Return Me.In1
            End Get
            Set(value As System.DateTime)
        ...
        Public Property SttlmInf() As SettlementInstruction2
            Get
                Return Me.sttlmInfField
            End Get
            Set(value As SettlementInstruction2)
    ...
    Partial Public Class GenericFinancialIdentification1
        Inherits EntityBase(Of GenericFinancialIdentification1)
    ...
    Partial Public Class CashAccount24
        Inherits EntityBase(Of CashAccount24)
    ...
    Partial Public Class MandateRelatedInformation10
        ...
        Public Property DtOfSgn() As System.DateTime
            Get
        ...
        Public Property FnlColtDt() As System.DateTime
            Get
    ...
    <System.ComponentModel.DesignerCategoryAttribute("code")> _
    <System.Xml.Serialization.XmlTypeAttribute([Namespace]:="urn:iso:std:iso:20022:tech:xsd:pacs.003.001.06")> _
    Partial Public Class DirectDebitTransaction8
        ...
        Public Sub New()
            MyBase.New()
            Me.MndtRltdInf = New MandateRelatedInformation10
        End Sub
        ''' <remarks/>
    ...
    <System.ComponentModel.DesignerCategoryAttribute("code")> _
    <System.Xml.Serialization.XmlTypeAttribute([Namespace]:="urn:iso:std:iso:20022:tech:xsd:pacs.003.001.06")> _
    Partial Public Class DirectDebitTransactionInformation20
        Inherits EntityBase(Of DirectDebitTransactionInformation20)
        ...
        Private drctDbtTxField As DirectDebitTransaction8
        ...
        Public Sub New()
            ...
            'Me.sttlmInfField = New SettlementInformation14
            'Me.intrBkSttlmDtField = New System.DateTime
            Me.DrctDbtTx = New DirectDebitTransaction8
        End Sub
        ''' <remarks/>
        ...
        'Public Property ColltnDt() As System.DateTime
        '    Get
        ...
        ''' <remarks/>
        <System.Xml.Serialization.XmlElementAttribute("ReqdColltnDt", DataType:="date")> _
        Public Property RCDt() As System.DateTime
            Get
                Return Me.reqdColltnDtField
            End Get
            Set(value As System.DateTime)
        ...
        ''' <remarks/>
        Public Property DrctDbtTx() As DirectDebitTransaction8
            Get
                Return Me.drctDbtTxField
            End Get
            Set(value As DirectDebitTransaction8)
    ...
    <System.ComponentModel.DesignerCategoryAttribute("code")> _
    <System.Xml.Serialization.XmlTypeAttribute([Namespace]:="urn:iso:std:iso:20022:tech:xsd:pacs.003.001.06")> _
    Partial Public Class SettlementInstruction2
