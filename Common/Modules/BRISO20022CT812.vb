...
Namespace BRISO20022CT812 ' Credit Transfer 812
...
#End Region
    ...
    Partial Public Class Document
        ...
        Public Property FIToFICstmrCdtTrf() As FIToFICustomerCreditTransferV02
            ...
            End Get
            Set(value As FIToFICustomerCreditTransferV02)
    ...
    Partial Public Class FIToFICustomerCreditTransferV02
        ...
        Public Property CdtTrfTxInf() As List(Of CreditTransferTransactionInformation11)
            ...
            End Get
            Set(value As List(Of CreditTransferTransactionInformation11))
    ...
    Partial Public Class GroupHeader33
        ...
        Public Property IntrBkStDate() As System.DateTime
            Get
    ...
    Partial Public Class CreditTransferTransactionInformation11
        ...
        Private prvsInstgAgtField As BranchAndFinancialInstitutionIdentification4

        Private prvsInstgAgtAcctField As CashAccount16
        ...
        ''' <remarks/>
        Public Property PrvsInstgAgt() As BranchAndFinancialInstitutionIdentification4
            Get
        ...
        ''' <remarks/>
        Public Property PrvsInstgAgtAcct() As CashAccount16
            Get
